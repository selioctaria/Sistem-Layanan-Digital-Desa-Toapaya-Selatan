...
$query = "SELECT * FROM profile_user WHERE email = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nama) || empty($phone) || empty($pekerjaan) || empty($status) || empty($gender) || empty($address)) {
        echo "<script>alert('Semua field harus diisi');</script>";
    } else {
        // Update query dengan prepared statement
        $update_query = "UPDATE profile_user SET 
                            nama = ?, 
                            phone = ?, 
                            pekerjaan = ?, 
                            status = ?, 
        ...
        $update_stmt->bind_param("ssssssss", $nama, $phone, $pekerjaan, $status, $gender, $address, $foto, $email);

        // Eksekusi query update
        if ($update_stmt->execute()) {
            echo "<script>alert('Profil berhasil diperbarui'); window.location='user-profil.php';</script>";
        } else {
    ...
    <div class="container">
        <aside class="sidebar-container">
            ...
            <div class="sidebar">
                ...
                <a href="user-profil.php" class="active"><span class="material-icons-sharp">person</span><h3>Profile</h3></a>
                <a href="#" id="logout">
            ...
            <div class="profile-container">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="pekerjaan" name="pekerjaan" value="<?= htmlspecialchars($user['pekerjaan']); ?>" required>
                    </div>
